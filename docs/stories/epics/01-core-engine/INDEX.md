...
| CORE-3 | [Automatic Downtime Logic (Timeout)](story-CORE-3-automatic-downtime-timeout.md) | InProgress | Implementar o disparo automático de parada por inatividade. |
| CORE-4 | [Manual Downtime & Pulse Buffer](story-CORE-4-manual-downtime-pulse-buffer.md) | InProgress | Gerenciar paradas manuais e bufferizar pulsos recebidos durante a parada. |
| CORE-5 | [OP Contingency Flow](story-CORE-5-op-contingency-flow.md) | InProgress | Fluxo de abertura manual de OP quando a API estiver offline. |
